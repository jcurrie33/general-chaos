...
public class PolyNav2D : MonoBehaviour {
	...
	// Added by John Currie 12/13/16
	public static bool isPathfindingEnabled;

	// Enable/Disable pathfinding (Added by John Currie 12/13/16)
	public static void EnablePathfinding () { 
		PolyNav2D.isPathfindingEnabled = true;
	}
	public static void DisablePathfinding () {
		PolyNav2D.isPathfindingEnabled = false;
	}
	...
	void LateUpdate(){
		...
		// Added by John Currie 12/12/16
		if (!PolyNav2D.isPathfindingEnabled)
			return;
